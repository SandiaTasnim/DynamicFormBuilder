...
namespace DynamicFormBuilder.ViewModels
{
    public static class PaginationHelper
    {
            ...
            int[] pageSizeOptions = null)
        {
            ...
            builder.Append($"<button class='btn btn-sm btn-primary' style='background:#3385ff;border:#E1136E;' onclick=\"goToPageDirect('{urlWithoutPage}', {pagedList.PageCount})\">Go</button>");
            builder.Append("</div>");
